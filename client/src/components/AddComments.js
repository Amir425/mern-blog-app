...
const AddCommentForm = ({ articleName, setArticleInfo }) => {
  ...
  // Define an asynchronous function to add comments
  const addComments = async () => {
    // Use fetch to make a POST request to the specified API endpoint for adding comments
    ...
    // Update the article information with the new comment
    setArticleInfo(body);

    // Clear the username and comment text fields
    setUsername("");
    setCommentText("");
  };
